...
#	@Smoke_USMM
#	Scenario Outline: Verify Patient Timer Feature While User Is On Patient Grid_Billable - Timer Box Opened
...
#		   * I select the appointment status
#		   * I enter appointmentComment <AppointmentComment> as appointmentcomment
#		   * I click on save button to save appointment
#		   * I should see appoitment_success <AppointmentSucessMessage> of appointmentSuccess
#		   
#		   
...
#
#		Examples: 
#			| Patient          | TimerSucessMessage                                     | Comment | Diagnosis | Title          | SucessMessage                           | Enter_Notes                                                               | Code_Name                                                 | Start_Date | Severity | Type      | Status | Rank      | Source_Type | Name                                                              | Frequency     | Route            | Start_Date | Prescribed_By | CPOE | eSent | Drug_Formulacy | Directions                  | Source | Billable | Encounter                                               | StartDate            | EndDate              | ServingFacility | Disposition | Disfacility   | Location | POS            | VisitType  | NoteType      | ApptProvider | RendringProvider | RefrenceProvider | AssesmentTitle              | CPTCode   | AssesmentComment                                                                    |
#			| Dermo505, Mac505 | successPatient Time has been updated successfully.Hide | Test    | T79.5xxA  | TestingPatient | successCare Plan Saved SuccessfullyHide | Lorem Ipsum is simply dummy text of the printing and typesetting industry | Cholera due to Vibrio cholerae 01, biovar cholerae::A00.0 |   01072021 | Moderate | Condition | Active | Principal | MMSL        | Humulin R U-500 KwikPen 500unit/ml Solution for Injection::100034 | 3 times a day | Auricular (otic) |   12102020 | Mason, Elijah | Yes  | Yes   | Yes            | As per the doctor recommend | C4     | Yes      | Observation care, typically 30 minutes are spent::99218 | 12192020 01:30:00 AM | 12072021 01:30:00 AM | MHPN3           | SNF         | Charlie SNF 1 | pakistan | Allergy clinic | Telehealth | Referral Note | aaaa, aa     | Mason, Elijah    | A JAFFER         | Assessment Testing | Test Code | Lorem Ipsum is simply dummy text of the printing and typesetting industry. |
#
	@Smoke_USMM
    ...
    * I enter telephonic outreach <Duration> as durations
    * I select outreach call type
    * I select outreach status
    * I enter telephonic outreach <Follow_Up_Plan> as follow up plan
    * I select Has patient gone to ER since placed on TOR within last thirty daysss?
    * I select Was patient admittedreadmitted to acute care since placed on TOR in last thirty daysss?
    * I select Was ER visit or Acute Admission preventabless?
...
Examples: 
			...
			| Dermo505, Mac505 | successPatient Time has been updated successfully.Hide | Test    | T79.5xxA  | TestingPatient | successCare Plan Saved SuccessfullyHide | Lorem Ipsum is simply dummy text of the printing and typesetting industry | Cholera due to Vibrio cholerae 01, biovar cholerae::A00.0 |   01072021 | Moderate | Condition | Active | Principal | MMSL        | Humulin R U-500 KwikPen 500unit/ml Solution for Injection::100034 | 3 times a day | Auricular (otic) |   12102020 | Mason, Elijah | Yes  | Yes   | Yes            | As per the doctor recommend | C4     | Yes      | Observation care, typically 30 minutes are spent::99218 | 12192020 01:30:00 AM | 12072021 01:30:00 AM | MHPN3           | SNF         | Charlie SNF 1 | pakistan | Allergy clinic | Telehealth | Referral Note | aaaa, aa     | Mason, Elijah    | A JAFFER         | Assessment Testing | Test Code | Lorem Ipsum is simply dummy text of the printing and typesetting industry. |03152021 03:20 AM | mason,   | 10:15:20 | Education      |
#
#
#
#
