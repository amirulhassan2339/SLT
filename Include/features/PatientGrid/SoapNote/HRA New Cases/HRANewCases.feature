...
#		   * I should see signed status icon on appointment ui page
		...
		Examples: 
			| Patient          | Reason    | LocationOfVisit1              | Code1 | LocationOfVisit2                 | Code2 | PADTestToday | ReasonTest | LeftResults | RightResults | DiagnosisCode | Facility | Constitutional       |MRN|
			| Dermo505, Mac505 | Back pain | Audio only over the telephone | 99443 | Telehealth utilizing audio/video | 99203 | Yes          | Diabetes   | 0.99-0.90   | 0.89-0.60    | Z13.6         | MHPN3    | In no acute distress |EntMerging505|
